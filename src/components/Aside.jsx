                ...
                <aside className="bg-zinc-700 flex flex-col items-center justify-between px-2 py-3 w-[50px] h-screen">
                    <div className="flex flex-col items-center gap-2">
                        <button className="hover:bg-zinc-600 px-1 py-1 rounded-md my-1" onClick={handleMaximize}>
                            <svg width="100%" height="100%" version="1.1" viewBox="0 0 20 20" x="0px" y="0px" role="presentation" aria-hidden="true" focusable="false" class="ScIconSVG-sc-1q25cff-1 jpczqG"><g><path d="M4 16V4H2v12h2zM13 15l-1.5-1.5L14 11H6V9h8l-2.5-2.5L13 5l5 5-5 5z"></path></g></svg>
                        </button>
